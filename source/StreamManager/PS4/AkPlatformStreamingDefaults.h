...
#define AK_DEFAULT_BLOCK_ALLOCATION_TYPE	(0)// Block allocation type.
...
#define AK_REQUIRED_IO_POOL_ALIGNMENT		(16)				// No requirement. If granularity is not a multiple of 2 KB, I/O data will be buffered by the system.
