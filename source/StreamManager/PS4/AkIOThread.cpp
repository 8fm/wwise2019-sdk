...
void CAkIOThread::Signal()
{
	AkAutoLock<CAkIOThread> chgSem( *this );
	for ( AkInt32 i = 0; i < m_defferedSemaphoreReleases; ++i )
		scePthreadCondSignal( &m_condAreTasksPending );
	m_defferedSemaphoreReleases = 0;
}
