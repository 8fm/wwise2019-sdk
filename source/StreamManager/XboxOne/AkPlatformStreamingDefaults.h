...
#define AK_DEFAULT_BLOCK_ALLOCATION_TYPE	(AkMemType_Device) // Block allocation type. We use the APU Alloc hook to enable SHAPE usage from streaming buffers.
...
#define AK_REQUIRED_IO_POOL_ALIGNMENT		(2048)	 // Equals to SHAPE_XMA_INPUT_BUFFER_ALIGNMENT.
