...
class ISoundFramePrivate
	: public ISoundFrame
{
public:
	virtual void * GetCopyData() = 0;
	virtual void SetCopyData( void * ) = 0;
};

class CSoundFrame
	: public CRefCountBase<ISoundFramePrivate>
{
public:
	CSoundFrame( IClient * );
	~CSoundFrame();
	...
	virtual bool SeekOnEvent(AkUniqueID in_eventID,AkGameObjectID in_gameObjectID,AkTimeMs in_iPosition,bool in_bSeekToNearestMarker = false,AkPlayingID in_PlayingID = AK_INVALID_PLAYING_ID);
	virtual bool SeekOnEvent(AkUniqueID in_eventID,AkGameObjectID in_gameObjectID,AkReal32 in_fPercent,bool in_bSeekToNearestMarker = false,AkPlayingID in_PlayingID = AK_INVALID_PLAYING_ID);
...
**/
	...
	virtual bool SetListeners( AkGameObjectID in_emitterGameObj, const AkGameObjectID* in_pListenerGameObjs, AkUInt32 in_uNumListeners );
	...
	virtual bool SetListenerSpatialization( AkUInt32 in_uiIndex, bool in_bSpatialized, AkChannelConfig in_channelConfig, AkReal32 * in_pVolumeOffsets = NULL );
	...
	virtual bool SetGameObjectOutputBusVolume( AkGameObjectID in_gameObjectID, AkGameObjectID in_listenerID, AkReal32 in_fControlValue );
	...
	virtual bool GetSoundBank( AkUniqueID in_SoundBankID, ISoundBank ** out_ppSoundBank ) const;
	virtual bool GetSoundBankList( ISoundBankList ** out_ppSoundBankList ) const;
	...
	virtual bool ProcessSoundBankDnD( IDataObject * in_pDataObject, ISoundBankList ** out_ppSoundBankList );
	...
	virtual bool ShowWwiseObject( const GUID* in_pGuids, long in_cGuids, ShowLocation in_eLocation );
	...
	// ISoundFramePrivate
	virtual void * GetCopyData();
	virtual void SetCopyData( void * );
