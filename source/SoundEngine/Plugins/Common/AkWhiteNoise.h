...
namespace DSP
{
	...
	public:
		...
		inline CAkWhiteNoise() : m_uLCGState(0) {}

		inline void Init(AkUInt32 in_uLCGState) { m_uLCGState = in_uLCGState; }
		...
		inline AkReal32 GenerateAudioSample()
		{
