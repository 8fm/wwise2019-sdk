...
// Creation function
AK::IAkPluginParam * CreateAkRoomVerbFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
                                         ...
                                         )
{
	...
	case AK_ROOMVERBFXPARAM_DIFFUSION_ID:
	{
		...
		sRTPCParams.fDiffusion = AkClamp( fValue, 0.f, 100.f );
		sRTPCParams.bDirty = true;
		break;
	}
	...
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		sRTPCParams.fStereoWidth = AkClamp( fValue, 0.f, 180.f );
		sRTPCParams.bDirty = true;
		break;
	}
	...
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		sRTPCParams.fFilter1Gain = AkClamp( fValue, -32.f, 32.f );
		sRTPCParams.bDirty = true;
		break;
	}
	...
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		sRTPCParams.fFilter2Gain = AkClamp( fValue, -32.f, 32.f );
		sRTPCParams.bDirty = true;
		break;
	}
	...
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		sRTPCParams.fFilter3Gain = AkClamp( fValue, -32.f, 32.f );
		sRTPCParams.bDirty = true;
		break;
	}
	...
	case AK_ROOMVERBFXPARAM_FRONTLEVEL_ID:
	{
		...
		sRTPCParams.fFrontLevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_REARLEVEL_ID:
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fRearLevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_CENTERLEVEL_ID:	
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fCenterLevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_LFELEVEL_ID:	
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fLFELevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_DRYLEVEL_ID:
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fDryLevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_ERLEVEL_ID:
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fERLevel = AK_DBTOLIN( fValue );
		sRTPCParams.bDirty = true;
		break;
	}
	case AK_ROOMVERBFXPARAM_REVERBLEVEL_ID:	
	{
		AkReal32 fValue = *((AkReal32*)in_pValue);
		fValue = AkClamp( fValue, -96.3f, 0.f );
		sRTPCParams.fReverbLevel = AK_DBTOLIN( fValue + REVERBLEVEL_OFFSET );
		sRTPCParams.bDirty = true;
		break;
	}
