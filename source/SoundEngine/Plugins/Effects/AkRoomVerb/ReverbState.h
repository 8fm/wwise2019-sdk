...
struct ReverbState
{
	ReverbState() : arOutputDecorrelators(NULL), uNumOutputDecorrelators( 0 ) {}

	DSP::AllpassFilter			DiffusionFilters[NUMDIFFUSIONALLPASSFILTERS];
	DSP::AllpassFilter *		arOutputDecorrelators;	/// LX REVIEW Decorrelation filters for HOA
	...
	AkUInt32					uNumOutputDecorrelators;
...
{	
	DSP::BiquadFilterMonoSIMD	Filter;
