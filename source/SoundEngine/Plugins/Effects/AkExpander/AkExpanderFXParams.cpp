...
// Creation function
AK::IAkPluginParam * CreateAkExpanderFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
											...
											AkUInt32 in_ulParamSize )
{
	...
	case AK_EXPANDERFXPARAM_THRESHOLD_ID:
		...
		m_Params.fThreshold = AkClamp( m_Params.fThreshold, -96.3f, 0.f );
		break;
