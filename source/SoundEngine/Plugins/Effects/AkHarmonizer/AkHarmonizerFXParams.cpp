...
// Creation function
AK::IAkPluginParam * CreateAkHarmonizerFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
												...
												AkUInt32 in_ulParamSize )
{
	...
	case AKHARMONIZERPARAMID_DRYLEVEL:
	{
		...
		fValue = AkClamp( fValue, -96.f, 24.f );
	...
	case AKHARMONIZERPARAMID_VOICE1GAIN:
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		fValue = AkClamp( fValue, -96.f, 24.f );
		m_Params.Voice[0].fGain = AK_DBTOLIN(fValue);
		break;
	}
	...
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		m_Params.Voice[0].Filter.fFilterGain = AkClamp( fValue, -24.f, 24.f );
		break;
	}
	...
	case AKHARMONIZERPARAMID_VOICE2GAIN:
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		fValue = AkClamp( fValue, -96.f, 24.f );
		m_Params.Voice[1].fGain = AK_DBTOLIN(fValue);
		break;
	}
	...
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		m_Params.Voice[1].Filter.fFilterGain = AkClamp( fValue, -24.f, 24.f );
		break;
	}
