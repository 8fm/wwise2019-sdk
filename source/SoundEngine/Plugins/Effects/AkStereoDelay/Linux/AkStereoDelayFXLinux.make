...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkStereoDelayFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkStereoDelayFX.a
  OBJDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/obj/$(PREMAKE4_BUILDTARGET_BASENAME)
  DEFINES += -DAKSOUNDENGINE_EXPORTS -D_DEBUG
  INCLUDES += -I.. -I. -I../../../../../../include -I../../Common/Linux -I../../Common -I../../../Common -I../../../../../../include/AK/DSP -I../../../../AkAudiolib/Common
  FORCE_INCLUDE +=
...
OBJECTS := \
	$(OBJDIR)/Mix2Interp.o \
	$(OBJDIR)/Mix3Interp.o \
	$(OBJDIR)/AkStereoDelayDSPProcess.o \
	$(OBJDIR)/AkStereoDelayFX.o \
	$(OBJDIR)/AkStereoDelayFXParams.o \
	$(OBJDIR)/AkStereoDelayLine.o \
	$(OBJDIR)/InitAkStereoDelayFX.o \
...
$(OBJDIR)/Mix3Interp.o: ../../Common/Mix3Interp.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkStereoDelayDSPProcess.o: ../AkStereoDelayDSPProcess.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkStereoDelayFX.o: ../AkStereoDelayFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkStereoDelayFXParams.o: ../AkStereoDelayFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkStereoDelayLine.o: ../AkStereoDelayLine.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkStereoDelayFX.o: ../InitAkStereoDelayFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
