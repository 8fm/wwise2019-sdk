...
enum AkMeterScope
{
	AkMeterScope_Global = 0,
	AkMeterScope_GameObject
};
...
static const AkPluginParamID AK_METERFXPARAM_APPLYDOWNSTREAMVOLUME_ID = 7;
static const AkPluginParamID AK_METERFXPARAM_SCOPE_ID = 8;
...
#define AK_METER_SCOPE_DEF					(AkMeterScope_Global)
...
#define AK_METER_APPLYDOWNSTREAMVOLUME_DEF	(false)
