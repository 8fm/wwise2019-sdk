...
namespace DSP
{
	...
	{
		COMPUTELRMIX(in_fStereoWidthPrev, in_fStereoWidthNext);
		out_fGain1 = fGain1;
		out_fGain2 = fGain2;
		out_fPrevGain1 = fPrevGain1;
		out_fPrevGain2 = fPrevGain2;
	}
						...
						AkReal32 in_fStereoWidth )
	{
		...
		AkUInt32 uChannelMask = io_pBuffer->GetChannelConfig().uChannelMask;
		...
		if ( AK::HasSurroundChannels( uChannelMask ) )  
		{
			...
			if ( AK::HasSideAndRearChannels( uChannelMask ) )  
			{
