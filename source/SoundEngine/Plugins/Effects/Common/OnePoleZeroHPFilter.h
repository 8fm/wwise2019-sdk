...
namespace DSP
{
	...
	public:
		...
		void ComputeCoefs( AkReal32 in_fCutFreq, AkUInt32 in_uSampleRate )
		{
		...
		void Reset( )
		{
		 ...
		 void ProcessBufferWithGain( AkReal32 * io_pfBuffer, AkUInt32 in_uNumFrames, AkReal32 in_fGain );
