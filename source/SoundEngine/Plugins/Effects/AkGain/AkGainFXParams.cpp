...
// Creation function
AK::IAkPluginParam * CreateAkGainFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
											...
											AkUInt32 in_ulParamSize )
{
	...
	case AK_GAINFXPARAM_FULLBANDGAIN_ID:
	{
		...
		m_Params.fFullbandGain = AkClamp( fValue, -96.3f, 24.f );
		break;
	}
	case AK_GAINFXPARAM_LFEGAIN_ID:
	{
		AkReal32 fValue = *reinterpret_cast<const AkReal32*>(in_pValue);
		m_Params.fLFEGain = AkClamp( fValue, -96.3f, 24.f );
		break;
	}
	default:
