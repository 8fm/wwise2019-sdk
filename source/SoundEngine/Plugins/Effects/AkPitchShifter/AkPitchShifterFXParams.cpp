...
// Creation function
AK::IAkPluginParam * CreateAkPitchShifterFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
												...
												AkUInt32 in_ulParamSize )
{
	...
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		fValue = AkClamp( fValue, -2400.f, 2400.f );
		m_Params.Voice.fPitchFactor = AK_PITCH2FACTOR(fValue);
		break;
	}
	...
	{
		AkReal32 fValue = *(AkReal32*)in_pValue;
		m_Params.Voice.Filter.fFilterGain = AkClamp( fValue, -24.f, 24.f );
		break;
	}
