...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkParametricEQFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkParametricEQFX.a
...
OBJECTS := \
	$(OBJDIR)/AkParametricEQFX.o \
	$(OBJDIR)/AkParametricEQFXParams.o \
	$(OBJDIR)/InitAkParametricEQFX.o \
...
clean:
	@echo Cleaning AkParametricEQFX
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/AkParametricEQFX.o: ../AkParametricEQFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkParametricEQFXParams.o: ../AkParametricEQFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkParametricEQFX.o: ../InitAkParametricEQFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
