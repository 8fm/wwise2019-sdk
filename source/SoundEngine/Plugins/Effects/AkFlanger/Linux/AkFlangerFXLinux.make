...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkFlangerFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkFlangerFX.a
...
OBJECTS := \
	$(OBJDIR)/AkFlangerFX.o \
	$(OBJDIR)/AkFlangerFXParams.o \
	$(OBJDIR)/LFO.o \
	$(OBJDIR)/Mix2Interp.o \
	$(OBJDIR)/UniComb.o \
	$(OBJDIR)/InitAkFlangerFX.o \
...
$(OBJDIR)/AkFlangerFX.o: ../AkFlangerFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkFlangerFXParams.o: ../AkFlangerFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/Mix2Interp.o: ../../Common/Mix2Interp.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/UniComb.o: ../../Common/UniComb.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkFlangerFX.o: ../InitAkFlangerFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
