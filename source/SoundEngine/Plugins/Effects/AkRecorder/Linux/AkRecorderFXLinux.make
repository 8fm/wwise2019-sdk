...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkRecorderFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkRecorderFX.a
  OBJDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/obj/$(PREMAKE4_BUILDTARGET_BASENAME)
  DEFINES += -DAKSOUNDENGINE_EXPORTS -D_DEBUG -DAUDIOKINETIC
  INCLUDES += -I.. -I. -I../../../../../../include -I../../Common/Linux -I../../Common -I../../../Common -I../../../../AkAudiolib/Common -I../../../../AkAudiolib/Linux
  FORCE_INCLUDE +=
...
OBJECTS := \
	$(OBJDIR)/AkRecorderFX.o \
	$(OBJDIR)/AkRecorderFXParams.o \
	$(OBJDIR)/AkRecorderManager.o \
	$(OBJDIR)/InitAkRecorderFX.o \
...
$(OBJDIR)/AkRecorderFX.o: ../AkRecorderFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkRecorderFXParams.o: ../AkRecorderFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkRecorderManager.o: ../AkRecorderManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkRecorderFX.o: ../InitAkRecorderFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
