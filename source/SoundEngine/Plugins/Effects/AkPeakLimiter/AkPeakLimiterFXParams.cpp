...
// Creation function
AK::IAkPluginParam * CreateAkPeakLimiterFXParams( AK::IAkPluginMemAlloc * in_pAllocator )
{
											...
											AkUInt32 in_ulParamSize )
{
	...
	case AK_PEAKLIMITERFXPARAM_THRESHOLD_ID:
	{
		...
		RTPC.fThreshold = AkClamp( fValue, -96.3f, 0.f );
		RTPC.bDirty = true;
		break;
	}
	...
	case AK_PEAKLIMITERFXPARAM_GAIN_ID:
	{
		...
		RTPC.fOutputLevel  = powf( 10.f, fValue * 0.05f );
		RTPC.bDirty = true;
		break;
	}
