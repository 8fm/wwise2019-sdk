...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkPeakLimiterFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkPeakLimiterFX.a
...
OBJECTS := \
	$(OBJDIR)/AkPeakLimiterFX.o \
	$(OBJDIR)/AkPeakLimiterFXParams.o \
	$(OBJDIR)/InitAkPeakLimiterFX.o \
...
$(OBJDIR)/AkPeakLimiterFX.o: ../AkPeakLimiterFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkPeakLimiterFXParams.o: ../AkPeakLimiterFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkPeakLimiterFX.o: ../InitAkPeakLimiterFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
