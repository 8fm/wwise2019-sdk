...
static const AKSIMD_DECLARE_V4F32_TYPE vOutDecorrelationVector[][4] =
{
	...
	{ {1.f,1.f,-1.f,1.f}, {-1.f,-1.f,-1.f,1.f}, {-1.f,1.f,-1.f,1.f}, {1.f,-1.f,1.f,-1.f} },
#endif
	// For now, the height channels are just set to zero.  TODO: Come up with proper decorrelation vectors for the height channels, or do not process them
...
// LFE decorrelation vector will be applied to the last channel if process LFE is active.
static const AKSIMD_DECLARE_V4F32_TYPE vOutDecorrelationVectorLFE[4] =
	{ { 1.f, 1.f, -1.f, -1.f }, { -1.f, -1.f, 1.f, 1.f }, { 1.f, 1.f, -1.f, -1.f }, { -1.f, -1.f, 1.f, 1.f } };
...
AK::IAkPlugin* CreateAkMatrixReverbFX( AK::IAkPluginMemAlloc * in_pAllocator )
{
...
, m_uNumProcessedChannels(0)
{
	...
	AKPLATFORM::AkMemSet(m_vIIRLPFB0, 0, MAXNUMDELAYGROUPS*sizeof(AKSIMD_V4F32));
	AKPLATFORM::AkMemSet(m_vIIRLPFA1, 0, MAXNUMDELAYGROUPS*sizeof(AKSIMD_V4F32));
	AKPLATFORM::AkMemSet(m_vIIRLPFMem, 0, MAXNUMDELAYGROUPS*sizeof(AKSIMD_V4F32));
}
							   ...
							   )
{
	...
	if ( in_rFormat.channelConfig.eConfigType != AK_ChannelConfigType_Standard )
	{
		return AK_UnsupportedChannelConfig;
	}

	AKRESULT eResult = InitDelayLines( in_rFormat.channelConfig );
	return eResult;
}
...
void CAkFDNReverbFX::Execute( AkAudioBuffer* io_pBuffer )
{
	...
	{
		AKRESULT eResult = InitDelayLines( io_pBuffer->GetChannelConfig() );
...
AKRESULT CAkFDNReverbFX::InitDelayLines( AkChannelConfig in_channelConfig )
{
	TermDelayLines();
	...
	AkChannelMask uChannelMask = in_channelConfig.uChannelMask;
...
#define DELAY4PROCESSSETUP() \
	...
	AkReal32* pfDelayWrite0 = m_pfDelayWrite[0]; \
	AkReal32* pfDelayRead0 = m_pfDelayRead[0]; \
	AkReal32* pfDelayRead1 = m_pfDelayRead[1]; \
	AkReal32* pfDelayRead2 = m_pfDelayRead[2]; \
	AkReal32* pfDelayRead3 = m_pfDelayRead[3]; \
	const AKSIMD_V4F32 vIIRLPFB0 = m_vIIRLPFB0[0]; \
	const AKSIMD_V4F32 vIIRLPFA1 = m_vIIRLPFA1[0]; \
	AKSIMD_V4F32 vIIRLPFMem0 = m_vIIRLPFMem[0];
...
#define DELAY8PROCESSSETUP() \
	...
	AkReal32* pfDelayWrite0 = m_pfDelayWrite[0]; \
	AkReal32* pfDelayWrite1 = m_pfDelayWrite[1]; \
	AkReal32* pfDelayRead0 = m_pfDelayRead[0]; \
	AkReal32* pfDelayRead1 = m_pfDelayRead[1]; \
	AkReal32* pfDelayRead2 = m_pfDelayRead[2]; \
	AkReal32* pfDelayRead3 = m_pfDelayRead[3]; \
	AkReal32* pfDelayRead4 = m_pfDelayRead[4]; \
	AkReal32* pfDelayRead5 = m_pfDelayRead[5]; \
	AkReal32* pfDelayRead6 = m_pfDelayRead[6]; \
	AkReal32* pfDelayRead7 = m_pfDelayRead[7]; \
	const AKSIMD_V4F32 vIIRLPFB0[2] = { m_vIIRLPFB0[0], m_vIIRLPFB0[1] }; \
	const AKSIMD_V4F32 vIIRLPFA1[2] = { m_vIIRLPFA1[0], m_vIIRLPFA1[1] }; \
	AKSIMD_V4F32 vIIRLPFMem0 = m_vIIRLPFMem[0]; \
	AKSIMD_V4F32 vIIRLPFMem1 = m_vIIRLPFMem[1];
...
#define DELAY12PROCESSSETUP() \
	...
	AkReal32* pfDelayWrite0 = m_pfDelayWrite[0]; \
	AkReal32* pfDelayWrite1 = m_pfDelayWrite[1]; \
	AkReal32* pfDelayWrite2 = m_pfDelayWrite[2]; \
	AkReal32* pfDelayRead0 = m_pfDelayRead[0]; \
	AkReal32* pfDelayRead1 = m_pfDelayRead[1]; \
	AkReal32* pfDelayRead2 = m_pfDelayRead[2]; \
	AkReal32* pfDelayRead3 = m_pfDelayRead[3]; \
	...
	AkReal32* pfDelayRead6 = m_pfDelayRead[6]; \
	AkReal32* pfDelayRead7 = m_pfDelayRead[7]; \
	AkReal32* pfDelayRead8 = m_pfDelayRead[8]; \
	AkReal32* pfDelayRead9 = m_pfDelayRead[9]; \
	AkReal32* pfDelayRead10 = m_pfDelayRead[10]; \
	AkReal32* pfDelayRead11 = m_pfDelayRead[11]; \
	...
	AKSIMD_V4F32 vIIRLPFMem0 = m_vIIRLPFMem[0]; \
	AKSIMD_V4F32 vIIRLPFMem1 = m_vIIRLPFMem[1]; \
	AKSIMD_V4F32 vIIRLPFMem2 = m_vIIRLPFMem[2];
...
#define DELAY16PROCESSSETUP() \
	...
	AkReal32* pfDelayWrite1 = m_pfDelayWrite[1]; \
	AkReal32* pfDelayWrite2 = m_pfDelayWrite[2]; \
	AkReal32* pfDelayWrite3 = m_pfDelayWrite[3]; \
	AkReal32* pfDelayRead0 = m_pfDelayRead[0]; \
	AkReal32* pfDelayRead1 = m_pfDelayRead[1]; \
	AkReal32* pfDelayRead2 = m_pfDelayRead[2]; \
	AkReal32* pfDelayRead3 = m_pfDelayRead[3]; \
	...
	AkReal32* pfDelayRead10 = m_pfDelayRead[10]; \
	AkReal32* pfDelayRead11 = m_pfDelayRead[11]; \
	AkReal32* pfDelayRead12 = m_pfDelayRead[12]; \
	AkReal32* pfDelayRead13 = m_pfDelayRead[13]; \
	AkReal32* pfDelayRead14 = m_pfDelayRead[14]; \
	AkReal32* pfDelayRead15 = m_pfDelayRead[15]; \
	...
	AKSIMD_V4F32 vIIRLPFMem1 = m_vIIRLPFMem[1]; \
	AKSIMD_V4F32 vIIRLPFMem2 = m_vIIRLPFMem[2]; \
	AKSIMD_V4F32 vIIRLPFMem3 = m_vIIRLPFMem[3];
...
void CAkFDNReverbFX::ProcessN4( AkAudioBuffer * io_pBuffer )
{
	...
	//The last channel may or may not be the LFE.  Choose the appropriate decorrelation vector.
	const AKSIMD_DECLARE_V4F32_TYPE* vLastChDecorrelationVector = (m_pParams->NonRTPC.uProcessLFE) ? vOutDecorrelationVectorLFE : vOutDecorrelationVector[uNumProcessedChannels - 1];

	AKSIMD_V4F32 * vIn = (AKSIMD_V4F32 *) AkAlloca( sizeof( AKSIMD_V4F32 ) * uNumProcessedChannels );
	AKSIMD_V4F32 * vOut = (AKSIMD_V4F32 *) AkAlloca( sizeof( AKSIMD_V4F32 ) * uNumProcessedChannels );
	...
	while(uFramesToProcess)
	{
		...
		while (i < (uNumProcessedChannels - 1));
		vOut[i] = AKSIMD_MUL_V4F32(vLastChDecorrelationVector[0], vDampedDelayOutputs0);
		AKSIMD_V4F32 vScaleFactor = vDampedDelayOutputs0;
...
void CAkFDNReverbFX::ProcessN8( AkAudioBuffer * io_pBuffer )
{
	...
	while(uFramesToProcess)
	{
		...
		while (i < (uNumProcessedChannels - 1));
		vOut[i] = AKSIMD_MADD_V4F32(vLastChDecorrelationVector[1], vDampedDelayOutputs1, vOut[i]);
		vScaleFactor = AKSIMD_ADD_V4F32( vScaleFactor, vDampedDelayOutputs1 );
...
void CAkFDNReverbFX::ProcessN12( AkAudioBuffer * io_pBuffer )
{
	...
	while(uFramesToProcess)
	{
		...
		while (i < (uNumProcessedChannels - 1));
		vOut[i] = AKSIMD_MADD_V4F32(vLastChDecorrelationVector[2], vDampedDelayOutputs2, vOut[i]);
		vScaleFactor = AKSIMD_ADD_V4F32( vScaleFactor, vDampedDelayOutputs2 );
...
void CAkFDNReverbFX::ProcessN16( AkAudioBuffer * io_pBuffer )
{
	...
	while(uFramesToProcess)
	{
		...
		while (i < (uNumProcessedChannels - 1));
		vOut[i] = AKSIMD_MADD_V4F32(vLastChDecorrelationVector[3], vDampedDelayOutputs3, vOut[i]);
		vScaleFactor = AKSIMD_ADD_V4F32( vScaleFactor, vDampedDelayOutputs3 );
