...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkMatrixReverbFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkMatrixReverbFX.a
...
OBJECTS := \
	$(OBJDIR)/AkFDNReverbFX.o \
	$(OBJDIR)/AkFDNReverbFXParams.o \
	$(OBJDIR)/InitAkMatrixReverbFX.o \
...
clean:
	@echo Cleaning AkMatrixReverbFX
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/AkFDNReverbFX.o: ../AkFDNReverbFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkFDNReverbFXParams.o: ../AkFDNReverbFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkMatrixReverbFX.o: ../InitAkMatrixReverbFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
