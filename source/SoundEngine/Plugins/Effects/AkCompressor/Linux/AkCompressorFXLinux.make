...
ifeq ($(config),debug)
  PREMAKE4_BUILDTARGET_BASENAME = AkCompressorFX
  TARGETDIR = ../../../../../../Linux_$(AK_LINUX_ARCH)/Debug/lib
  TARGET = $(TARGETDIR)/libAkCompressorFX.a
...
OBJECTS := \
	$(OBJDIR)/AkCompressorFX.o \
	$(OBJDIR)/AkCompressorFXParams.o \
	$(OBJDIR)/InitAkCompressorFX.o \
...
$(OBJDIR)/AkCompressorFX.o: ../AkCompressorFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/AkCompressorFXParams.o: ../AkCompressorFXParams.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/InitAkCompressorFX.o: ../InitAkCompressorFX.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
