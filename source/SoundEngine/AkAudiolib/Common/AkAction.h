...
#define ACTION_TYPE_RELEASE				0x1F00

#define ACTION_TYPE_SETHPF				0x2000
#define ACTION_TYPE_PLAYEVENT			0x2100
#define ACTION_TYPE_RESET_PLAYLIST		0x2200
#define ACTION_TYPE_RESETHPF			0x3000
...
//  _M	 = Main object is affected (AudioNode Definition)
	...
	AkActionType_SetHPF_M			= ACTION_TYPE_SETHPF	 | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_SetHPF_O			= ACTION_TYPE_SETHPF	 | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT ,

	AkActionType_ResetHPF_M			= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_ResetHPF_O			= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT ,

	AkActionType_ResetHPF_ALL		= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ALL,
	AkActionType_ResetHPF_ALL_O		= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ALL | ACTION_TYPE_USE_OBJECT,

	AkActionType_ResetHPF_AE		= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ALL_EXCEPT,
	AkActionType_ResetHPF_AE_O		= ACTION_TYPE_RESETHPF	 | ACTION_TYPE_SCOPE_ALL_EXCEPT | ACTION_TYPE_USE_OBJECT,

	AkActionType_SetBusVolume_M		= ACTION_TYPE_SETBUSVOLUME	 | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_SetBusVolume_O		= ACTION_TYPE_SETBUSVOLUME	 | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT,

	AkActionType_ResetBusVolume_M	= ACTION_TYPE_RESETBUSVOLUME | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_ResetBusVolume_O   = ACTION_TYPE_RESETBUSVOLUME | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT,
	...
	AkActionType_PlayEvent			= ACTION_TYPE_PLAYEVENT | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT,
	...
	AkActionType_ResetPlaylist_E	= ACTION_TYPE_RESET_PLAYLIST | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_ResetPlaylist_E_O	= ACTION_TYPE_RESET_PLAYLIST | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT,
	...
	AkActionType_Release			= ACTION_TYPE_RELEASE  | ACTION_TYPE_SCOPE_ELEMENT,
	AkActionType_Release_O			= ACTION_TYPE_RELEASE  | ACTION_TYPE_SCOPE_ELEMENT | ACTION_TYPE_USE_OBJECT
...
public:
	...
	void ActionType(AkActionType in_ActionType);
