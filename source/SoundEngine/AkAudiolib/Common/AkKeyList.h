...
// NOTE : 
template <class T_KEY, class T_ITEM, ListAllocFlag TAllocFlag, AkMemID T_MEMID = AkMemID_Object> 
class CAkKeyList : public CAkList2< MapStruct<T_KEY, T_ITEM>, const MapStruct<T_KEY, T_ITEM>&, TAllocFlag, T_MEMID >
{
public:
//====================================================================================================
...
//====================================================================================================
	...
	{
		typename CAkKeyList<T_KEY,T_ITEM,TAllocFlag,T_MEMID>::ListItem* pCurrent = this->m_pFirst;
		while(pCurrent != NULL)
		{
...
//====================================================================================================
	...
	{
		typename CAkKeyList<T_KEY,T_ITEM,TAllocFlag,T_MEMID>::IteratorEx it = this->BeginEx();
		for ( ; it != this->End(); ++it )
		{
			if ( (*it).key == in_Key )
			{
