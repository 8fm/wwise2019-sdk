...
public:
	...
	virtual CAkContainerBaseInfo * Clone( AkUInt16 in_wItemCount ) const = 0;

	virtual AKRESULT SerializeHistory(
		AK::IWriteBytes * in_pBytes,
		AkUInt16 in_iPlaylistSize
		) = 0;

	virtual AKRESULT DeserializeHistory(
...
public:
	...
	// Returns a reference to a new object allocated therein, which is a copy of this. NULL if failed.
	virtual CAkContainerBaseInfo * Clone( AkUInt16 in_wItemCount ) const;
