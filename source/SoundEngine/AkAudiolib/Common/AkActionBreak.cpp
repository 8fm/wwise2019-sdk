...
{
	CAkActionBreak*	pActionBreak = AkNew(AkMemID_Event, CAkActionBreak(in_eActionType, in_ulID));
	...
	AkPendingAction * in_pAction )
{
	...
	g_pAudioMgr->BreakPendingAction( pNode, in_pAction->GameObj(), in_pAction->TargetPlayingID );
