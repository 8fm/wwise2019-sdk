...
public:
	...
	static void TransferRelevantMarkers(AkMarkerNotificationRange in_range, AkPipelineBuffer* in_pInputBuffer, AkPipelineBuffer* io_pBuffer, AkUInt32 in_ulBufferStartOffset, AkUInt32 in_ulNumFrames);
