...
public:
	...
	AKRESULT SetObsOccCurve( eCurveXType in_x, eCurveYType in_y, AkUInt32 in_ulNbPoints, AkRTPCGraphPoint in_paPoints[], AkCurveScaling in_eScaling );
	...
	AkForceInline bool IsCurveEnabled( eCurveXType in_x, eCurveYType in_y ) { return m_bCurveEnabled[in_x][in_y] && ConversionTable[in_x][in_y].IsInitialized(); }
...
private:
	...
	CAkConversionTable ConversionTable[MAX_CURVE_X_TYPES][MAX_CURVE_Y_TYPES]; //we use this for our obs/occ curves!
};
