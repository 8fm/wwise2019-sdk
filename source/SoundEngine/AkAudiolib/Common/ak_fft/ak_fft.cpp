        ...
        )
{
	...
	if ( k >= 2 )
	{
		...
		do 
		{
			...
			AKSIMD_V4F32 vScratch0 = AKSIMD_COMPLEXMUL_V4F32( vFoutM, vTw1 );
			...
			AKSIMD_V4F32 vScratch1 = AKSIMD_COMPLEXMUL_V4F32( vFoutM3, vTw3 );
			...
			vScratch1 = AKSIMD_COMPLEXMUL_V4F32( vFoutM2, vTw2 );		
			...
			vScratch1 = AKSIMD_MADD_V4F32(vScratch1, vSignA, vScratch3);			
			AKSIMD_STORE_V4F32( (AkReal32*)&Fout[m], vScratch1 );
			vScratch2 = AKSIMD_SHUFFLE_BADC( vScratch0 ); 	
			vScratch2 = AKSIMD_MADD_V4F32(vScratch2, vSignB, vScratch3);			
								   ...
								   )
{
	...
	vScratch0 = AKSIMD_COMPLEXMUL_V4F32( vFoutM, vTw1 );
	vFoutM3 = AKSIMD_MOVEHL_V4F32( F11F15, F10F14 ); 
	vTw3 = AKSIMD_LOAD_V4F32(st->simdTwiddles+10);	
	vScratch1 = AKSIMD_COMPLEXMUL_V4F32( vFoutM3, vTw3 );
