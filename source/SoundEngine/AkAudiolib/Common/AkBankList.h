...
inline AkHashType AkHash(AkBankKey in_key) { return (AkHashType)((AkUIntPtr)in_key.bankID + (AkUIntPtr)in_key.pInMemoryPtr); }
...
public:
	...
	typedef AkHashListBare<AkBankKey, CAkUsageSlot> AkListLoadedBanks;
