...
public:
	...
	AkUniqueID ResolvePath( AkUniqueID in_idEvent, AkArgumentValueID * in_pPath, AkUInt32 in_cPath, AkPlayingID in_idSequence, AkCandidateCallbackFunc in_candidateCallbackFunc = NULL, void* in_pCookie = NULL );
...
private:
	typedef AkArray<Node *, Node *> NodeArray;
	...
	Node * ResolvePathWeighted( AkArgumentValueID * in_pPath, AkUInt32 in_cPath, AkUniqueID in_idEvent, AkPlayingID in_idSequence, WeightedDecisionInfo& out_decisionInfo, AkCandidateCallbackFunc in_candidateCallbackFunc = NULL, void* in_pCookie = NULL );
	void _ResolvePathWeighted( Node * in_pRootNode, AkArgumentValueID * in_pPath, AkUInt32 in_cPath, WeightedCandidates & io_candidates, AkUniqueID in_idEvent = 0, AkCandidateCallbackFunc in_candidateCallbackFunc = NULL, void* in_pCookie = NULL );

	Node * _ResolvePath( Node * in_pRootNode, AkArgumentValueID * in_pPath, AkUInt32 in_cPath, AkUniqueID in_idEvent = 0, AkCandidateCallbackFunc in_candidateCallbackFunc = NULL, void* in_pCookie = NULL );
