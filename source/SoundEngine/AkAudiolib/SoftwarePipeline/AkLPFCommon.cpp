...
#define SRCBQFMINFREQ 50.f		// Total frequency range
#define SRCBQFMAXFREQ 20000.f
...
#define LINRANGEEND ( SRCBQFMAXFREQ - RANGETRANSPOINT )
...
inline AkReal32 _EvalCutoff( AkReal32 in_fCurrentLPFPar, const AkUInt32 in_uMaxFrames )
{
	AkReal32 fCutFreq;
	...
	return AkMin( 0.5f * 0.9f * AK_CORE_SAMPLERATE, fCutFreq);
}

AkReal32 AkLpfParamEval::EvalCutoff( AkReal32 in_fCurrentLPFPar, const AkUInt32 in_uMaxFrames )
{
	return _EvalCutoff(in_fCurrentLPFPar, in_uMaxFrames );
}

AkReal32 AkHpfParamEval::EvalCutoff( AkReal32 in_fCurrentHPFPar, const AkUInt32 in_uMaxFrames )
{
	return _EvalCutoff( (100.f - in_fCurrentHPFPar), in_uMaxFrames );
}
