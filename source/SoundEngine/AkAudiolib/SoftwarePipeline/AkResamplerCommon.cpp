							...
							AkInternalPitchState * io_pPitchState )
{
	...
	for ( AkUInt32 i = 0; i < uNumChannels; ++i )
	{
		...
		AkReal32 * AK_RESTRICT pOut = (AkReal32 * AK_RESTRICT)( io_pOutBuffer->GetChannel( AkChannelRemap( i, io_pPitchState ) ) ) + io_pPitchState->uOutFrameOffset;
								...
								AkInternalPitchState * io_pPitchState )
{
	...
	for ( AkUInt32 i = 0; i < uNumChannels; ++i )
	{
		...
		AkReal32 * pOutChan = io_pOutBuffer->GetChannel( AkChannelRemap( i, io_pPitchState ) ) + io_pPitchState->uOutFrameOffset;
							...
							AkInternalPitchState * io_pPitchState )
{
	...
	for ( AkUInt32 i = 0; i < uNumChannels; ++i )
	{
		...
		AkReal32 * AK_RESTRICT pfOutBuf = (AkReal32 * AK_RESTRICT) io_pOutBuffer->GetChannel( AkChannelRemap( i, io_pPitchState ) ) + io_pPitchState->uOutFrameOffset;
									...
									AkInternalPitchState * io_pPitchState )
{
	...
	do
	{
		...
		AkInt16 * AK_RESTRICT pInBufChan = pInBuf + i;
		pfOutBuf = (AkReal32 * AK_RESTRICT) io_pOutBuffer->GetChannel( AkChannelRemap( i, io_pPitchState ) ) + io_pPitchState->uOutFrameOffset;
								...
								AkAudioBuffer * io_pOutBuffer )
{
	...
	for ( AkUInt32 i = 0; i < uNumChannels; ++i )
	{
		...
		AkReal32 * AK_RESTRICT pOut = (AkReal32 * AK_RESTRICT)( io_pOutBuffer->GetChannel( AkAudioBuffer::StandardToPipelineIndex(io_pInBuffer->GetChannelConfig(), i) ) );
		for ( AkUInt32 j = 0; j < uFramesToCopy; ++j )
		{
			*pOut++ = *pIn;
			pIn += uNumChannels;
...
// Interleave floating point samples (for sample-accurate stitching of mixed interleaveness material)
								...
								AkAudioBuffer * io_pOutBuffer )
{
	...
	for ( AkUInt32 i = 0; i < uNumChannels; ++i )
	{
		AkReal32 * AK_RESTRICT pIn = (AkReal32 * AK_RESTRICT)( io_pInBuffer->GetChannel( AkAudioBuffer::StandardToPipelineIndex(io_pInBuffer->GetChannelConfig(), i) ) );
		AkReal32 * AK_RESTRICT pOut = (AkReal32 * AK_RESTRICT)( io_pOutBuffer->GetInterleavedData() ) + i;
		for ( AkUInt32 j = 0; j < uFramesToCopy; ++j )
		{
			*pOut = *pIn++;
			pOut += uNumChannels;
