...
public:
	...
	AKRESULT			Init( AkAudioFormat *    io_pFormat,		// Format.
	...
	inline AkReal32		GetLastRate() const { return m_Pitch.GetLastRate(); }
	...
	void				SwitchToNextSrc(CAkVPLSrcNode *pNext);

	void                PipelineAdded(AkAudioFormat *in_pFormat);
protected:
