...
class CAkSrcBaseEx : public IAkSoftwareCodec
{
public:
	...
	// iOS: AAC needs to be virtualied during interruptions.
	void ForceVirtualize();
	void ForceDevirtualize();

	virtual void SetInfiniteLooping() { SetLoopCnt( 0 ); }
...
protected:
	...
	// Overridable methods by sources.
	//

	// Returns sample rate of the source for the purpose of seeking.
	virtual AkUInt32 GetSourceSampleRate() const;
	...
	inline void ResetLoopCnt() { m_uLoopCnt = m_pCtx ? m_pCtx->GetLooping() : LOOPING_ONE_SHOT; }
