...
public:
	...
	void Seek( ActionParams& in_rAction );
...
public:
	...
	void NotifyUserCuesInRange(
		...
		const struct AkSegmentInfo & in_segmentInfo, // Segment info to pass to notification
...
private:
    ...
    typedef AkArray< AkMusicMarker, const AkMusicMarker&, ArrayPoolDefault, AkGrowByPolicy_NoGrow > MarkersArray;
