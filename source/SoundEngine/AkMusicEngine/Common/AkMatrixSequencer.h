...
public:
	...
	inline bool IsPlaybackPending()			{ return m_bCmdPlayPending; }
	...
	inline AkUniqueID SegmentID() { return m_segmentID; }
...
class CAkMatrixSequencer AK_FINAL : public IAkTriggerAware
{
public:
    CAkMatrixSequencer(
	...
	inline void SetParametersDirty( bool in_bLiveEdit ) { m_bParametersValid = false; m_bLiveEdit = in_bLiveEdit; }
	...
	inline AkReal32	GetPlaybackSpeed() { return m_musicParams.fPlaybackSpeed; }
    ...
    AkInt64 QueryStateChangeDelay( 
		...
		bool &			out_bStateGroupUsed,	// return whether the state group is used or not
	...
	CAkMidiClipMgr* GetMidiClipMgr() { return &m_midiClipMgr; }
...
private:
	...
	AkMusicParams		m_musicParams;	
	bool				m_bParametersValid;
	bool				m_bLiveEdit;

	CAkMidiClipMgr		m_midiClipMgr;
};
