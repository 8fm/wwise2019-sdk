...
public:
	...
	// Functions used to get/set playback history.	virtual bool CanKeepPlaybackHistory() const { return false; }
	virtual bool CanKeepPlaybackHistory() const { return true; }
	virtual bool SetPlaybackHistory( AkUniqueID in_musicNodeId, AkTimeMs in_timeLeftOff, AkUniqueID in_playlistId );
	virtual bool SetPlaybackHistory( AkUniqueID in_musicNodeId, const CAkMusicPackedHistory& in_history );
	virtual const CAkMusicPlaybackHistory* GetPlaybackHistory( AkUniqueID in_musicNodeId );
...
private:
    ...
    const AkMusicTransitionRule & GetTransitionRule( 
		...
		CAkMatrixAwareCtx * in_pDestContext,			// Destination context. 
		...
		bool &				out_bIsDestSequenceSpecific // Whether actual destination is a playlist or not
        );
...
private:
	...
	typedef CAkKeyArray< AkUniqueID, CAkMusicPlaybackHistory > AkNodeToHistoryMap;
	AkNodeToHistoryMap			m_mapNodeToHistory;	
