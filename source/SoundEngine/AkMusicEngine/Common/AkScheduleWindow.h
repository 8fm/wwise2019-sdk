...
public:
	...
	inline void Reset(
		bool				in_bFirstItemOnly			// If true, the window will be placed on the first item of the active chain the first time it is set. Otherwise, the item corresponds to the current time (default).
		)
	{
		m_arBranchStack.Clear();
