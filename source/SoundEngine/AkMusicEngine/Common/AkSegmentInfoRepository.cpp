...
AKRESULT CAkSegmentInfoRepository::CreateEntry( AkPlayingID in_PlayingID )
{
	...
	if ( pNewRecord )
	{
		...
		pNewRecord->segmentInfo.fBarDuration 		= 0.f;
		pNewRecord->segmentInfo.fBeatDuration 		= 0.f;
		pNewRecord->segmentInfo.fGridDuration 		= 0.f;
		pNewRecord->segmentInfo.fGridOffset 		= 0.f;
