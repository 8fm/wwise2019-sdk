...
//config.h was hand-modified after original auto-config.

//Rename exported symbols to avoid conflicts with other parties using Opus, with a different version.
...
#if defined(AK_DECLARE_FSEEKO_FTELLO)
