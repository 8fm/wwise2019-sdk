...
//RED
#  if defined(OPUS_GET_EXPERT_FRAME_DURATION_REQUEST) //&& !defined(AUDIOKINETIC)
...
# define OP_NCHANNELS_MAX (OPUS_CHANNEL_COUNT_MAX) // AUDIOKINETIC
...
//RED
#if !defined(OP_FIXED_POINT) //&& !defined(AUDIOKINETIC)
