...
/*AUDIOKINETIC*/
OP_WARN_UNUSED_RESULT int AK_op_read_float_no_copy(OggOpusFile *_of,
	float **_pcm, int * _packetduration) OP_ARG_NONNULL(1);
...
/*********************** AUDIOKINETIC **********************************/
int AK_open_seekable(OggOpusFile *_of, int in_curFileOffset, int in_fileSize, int in_targetPCM);
...
void AK_op_relocateMedia(void *_stream, unsigned char * _newLocation);
/*********************** AUDIOKINETIC **********************************/
/*@}*/
/*@}*/
