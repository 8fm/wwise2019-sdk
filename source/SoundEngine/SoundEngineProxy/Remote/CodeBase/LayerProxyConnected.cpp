		...
		case ILayerProxy::MethodSetRTPC:
			{
				...
				if( in_rSerializer.Get( setRTPC ) )
					pLayer->SetRTPC( setRTPC.m_RTPCID, setRTPC.m_RTPCType, setRTPC.m_RTPCAccum, setRTPC.m_paramID, setRTPC.m_RTPCCurveID, setRTPC.m_eScaling, setRTPC.m_pArrayConversion, setRTPC.m_ulConversionArraySize );
		...
		case ILayerProxy::MethodSetCrossfadingRTPC:
			{
				...
				if( in_rSerializer.Get( setCrossfadingRTPC ) )
					pLayer->SetCrossfadingRTPC( setCrossfadingRTPC.m_rtpcID, setCrossfadingRTPC.m_rtpcType );
