...
public:
	...
	{
		tSoundEngineObj * pDialogueEvent = static_cast<tSoundEngineObj *>( tBase::GetIndexable() );
		...
		case IMultiSwitchProxy::MethodSetAkPropF:
			{
				...
				{
					AkDeltaMonitor::OpenLiveEditBrace(pDialogueEvent->key);
