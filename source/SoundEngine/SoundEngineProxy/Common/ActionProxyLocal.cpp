...
ActionProxyLocal::ActionProxyLocal( AkActionType in_actionType, AkUniqueID in_id )
{
	...
	if( pIndexable )
	{
		...
		if (pAction->ActionType() != in_actionType )
		{
	...
	if( !pIndexable )
	{
		pIndexable = CAkAction::Create( in_actionType, in_id );
	}
...
void ActionStopProxyLocal::ApplyToStateTransitions( bool in_bApplyToStateTransitions )
{
	CAkActionStop* pIndexable = static_cast<CAkActionStop*>( GetIndexable() );
	if( pIndexable )
	{
		pIndexable->ApplyToStateTransitions( in_bApplyToStateTransitions );
	}
}

void ActionStopProxyLocal::ApplyToDynamicSequences( bool in_bApplyToDynamicSequences )
{
	CAkActionStop* pIndexable = static_cast<CAkActionStop*>( GetIndexable() );
	if( pIndexable )
	{
		pIndexable->ApplyToDynamicSequence( in_bApplyToDynamicSequences );
	}
}
...
void ActionPauseProxyLocal::ApplyToStateTransitions( bool in_bApplyToStateTransitions )
{
	CAkActionPause* pIndexable = static_cast<CAkActionPause*>( GetIndexable() );
	if( pIndexable )
	{
...
void ActionPauseProxyLocal::ApplyToDynamicSequences( bool in_bApplyToDynamicSequences )
{
	CAkActionPause* pIndexable = static_cast<CAkActionPause*>( GetIndexable() );
	if( pIndexable )
	{
...
void ActionResumeProxyLocal::ApplyToStateTransitions( bool in_bApplyToStateTransitions )
{
	CAkActionResume* pIndexable = static_cast<CAkActionResume*>( GetIndexable() );
	if( pIndexable )
	{
...
void ActionResumeProxyLocal::ApplyToDynamicSequences( bool in_bApplyToDynamicSequences )
{
	CAkActionResume* pIndexable = static_cast<CAkActionResume*>( GetIndexable() );
	if( pIndexable )
	{
...
void ActionSetGameParameterProxyLocal::BypassGameParameterInternalTransition( bool in_bBypassGameParameterInternalTransition )
{
	CAkActionSetGameParameter* pIndexable = static_cast<CAkActionSetGameParameter*>( GetIndexable() );
	if( pIndexable )
	{
		pIndexable->BypassGameParameterInternalTransition( in_bBypassGameParameterInternalTransition );
	}
}
