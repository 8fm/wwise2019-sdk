...
class ActionStopProxyLocal : public ActionExceptProxyLocal
								, virtual public IActionStopProxy
{
public:
	ActionStopProxyLocal( AkActionType in_actionType, AkUniqueID in_id ):ActionExceptProxyLocal( in_actionType, in_id ){}

	virtual void ApplyToStateTransitions( bool in_bApplyToStateTransitions );
	virtual void ApplyToDynamicSequences( bool in_bApplyToDynamicSequences );
};
...
public:
	...
	virtual void BypassGameParameterInternalTransition( bool in_bBypassGameParameterInternalTransition );
};
